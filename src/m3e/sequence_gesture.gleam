//// SequenceGesture is a non-visual element used to detect and interpret a sequence of gestures from an input stream
...
///
pub fn priority(record: SequenceGesture, priority: String) -> SequenceGesture {
